...
public class CreateSongGenreComponent {
    ...
    public CreateSongGenreComponent(SongGenreQueryRepository songGenreQueryRepository,
            MusicGenreQueryRepository musicGenreQueryRepository) {
    ...
    public void saveSongGenres(AlbumDetailEntity songId, List<GenreIdRequestDto> genreDtos) {
        List<UUID> genreIds = genreDtos.stream()
                .map(GenreIdRequestDto::getGenreId)
                .toList();
