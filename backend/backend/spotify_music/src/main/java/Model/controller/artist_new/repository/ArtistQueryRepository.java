...
public class ArtistQueryRepository {
    ...
    public void createArtist(RegisterArtistRequestDto dto) {
        ...
        if(repository.existsByName(dto.artistName())) {
            throw new ArtistException("Ya existe un artista registrado con este nombre. Por favor, elige uno distinto para que tus fans puedan encontrarte sin problemas.");
        }
